        ...
        <div className="relative border-b border-black/30 pb-24 md:min-h-[270px] md:pb-0">
          <div className="flex flex-col items-end gap-4 md:block">
            <motion.a
              ...
              whileHover={{ y: -6, rotate: -4, scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
          ...
          <motion.p
            ...
            className="mt-10 font-mono text-[10px] uppercase tracking-[0.2em] text-[#777] md:absolute md:bottom-8 md:left-0 md:mt-0 md:text-[11px] md:tracking-[0.22em]"
          >
            © Aman CK
          </motion.p>
        </div>
