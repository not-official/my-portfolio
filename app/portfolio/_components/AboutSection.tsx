      ...
      <div className="mx-auto max-w-6xl border-t border-[var(--line)] pt-12 transition-colors duration-300 md:pt-14">
        ...
        <div className="grid gap-10 md:grid-cols-[0.42fr_0.58fr] md:items-start">
          <div className="relative mx-auto w-full max-w-[360px] md:max-w-none">
            <div className="absolute -left-2 -top-2 z-0 h-full w-full border border-[var(--line)] bg-[var(--paper-soft)] transition-colors duration-300 md:-left-3 md:-top-3" />

            <div className="relative z-10 overflow-hidden border border-[var(--line)] bg-[var(--card)] p-2 backdrop-blur transition-colors duration-300 md:p-3">
              <div className="relative aspect-[4/5] overflow-hidden bg-[var(--paper-soft)] transition-colors duration-300">
                <Image
          ...
          <div>
            <p className="max-w-2xl text-3xl font-semibold leading-[1.18] tracking-[-0.04em] text-[var(--ink)] transition-colors duration-300 md:text-4xl md:leading-[1.25]">
              Jack of all trades, master of figuring it out.
            </p>

            <div className="mt-6 space-y-5 text-sm leading-7 text-[var(--muted-strong)] transition-colors duration-300 sm:text-base sm:leading-8 md:mt-7">
              <p>
            ...
            <div className="mt-7 flex flex-wrap gap-3 md:mt-8">
              <a
                ...
                className="border border-[var(--ink)] bg-[var(--ink)] px-4 py-3 font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--paper)] transition-colors duration-300 hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-white md:px-5 md:text-[11px] md:tracking-[0.2em]"
              >
                Resume
              </a>
              ...
              <a
                ...
                className="border border-[var(--ink)] px-4 py-3 font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--ink)] transition-colors duration-300 hover:bg-[var(--ink)] hover:text-[var(--paper)] md:px-5 md:text-[11px] md:tracking-[0.2em]"
              >
                Contact
              </a>
            </div>
